---
description: This tutorial will explain how to delegate/stake/unstake your SRI.
---

# Staking tutorial

Note: You can only stake SRI which is on SRI Blockchain network. Please make sure you have changed into SRI Blockchain network in Metamask while doing any transactions on staking UI. 

How to Stake SRI Blockchain:

**Step 1:**

Navigate to staking.poolscan.io and login to your wallet through metamask. Make sure you are on SRI Blockchain network. If you are not please follow the instructions [**here**](https://doc.poolscan.io/the-SRI-studio/getting-started/how-to-add-SRI-to-your-metamask).
...
You will also see the APY on staking when you enter the amount of SRI you want to stake. You can see the staked amount right next to the validator name to whom you have delegated you stake to. 
