...
description: >-
  ...
  the SRI Blockchain Studio. The guide is aimed at teaching you how to create a new
  community after setting up Metamask or Torus and is
---

# Community creation tutorial

Make sure you are connected to the SRI Blockchain network on your Metamask wallet before creating the community. Learn how to add SRI Blockchain network to Metamask using [this](https://doc.poolscan.io/the-SRI-studio/getting-started/how-to-add-SRI-to-your-metamask) tutorial.

Navigate to https://studio.poolscan.io/ and click on **“Login”** at the right hand top corner as shown below. Use your Gmail account to Sign in.
...
You can also view both your ETH balance and SRI balance by clicking on “SRI Blockchain network”
...
Select whether you want to **“Create a new token”** or **“Use an existing token on SRI Blockchain”**
...
Clicking on **“Issue”** will ask for a sign from your wallet. Please confirm the transaction from your wallet which is signed in to SRI Blockchain network.
...
It's been a long road, but you are finally on the last step! To be able to make easy mobile transactions using your community, **download the SRI Blockchain wallet app** on the [App Store](https://apps.apple.com/il/app/SRI-wallet/id1491783654) or [Google Play](https://play.google.com/store/apps/details?id=io.SRI.SRIcash).
