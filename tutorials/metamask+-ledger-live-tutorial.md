...
This tutorial will walk you through the steps needed to connect your Ledger to Metamask and use it to transact on SRI Blockchain after the latest Metamask and Ledger live update.
...
You will be logged in to the address you selected and now you can change the network to “SRI Blockchain network” and perform the transactions on SRI Blockchain network through your Ledger device.

Note: To learn how to add SRI Blockchain RPC follow [this link.](https://doc.poolscan.io/the-SRI-studio/getting-started/how-to-add-SRI-to-your-metamask)
