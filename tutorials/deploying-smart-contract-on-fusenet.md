---
description: Steps on deploying a smart contract on SRInet through Remix.
---

# Deploying smart contract on SRInet

SRI Blockchain is an EVM compatible network, every tool for Ethereum can be used for the SRI Blockchain network too.
...
Since we interact with remix using Metamask, you need to change the network to SRI Blockchain network by adding a custom RPC. Please follow the steps in [this tutorial](https://doc.poolscan.io/the-SRI-studio/getting-started/how-to-add-SRI-to-your-metamask) to do that.

You need to have a small balance of SRI on the SRInet wallet you are using which will be used as Gas for the transactions.
