...
Below tutorial will help you understand how to add SRI Blockchain network RPC on imToken through chainlist.org and transfer/receive tokens on SRI network in imToken wallet.   
...
**Step 4:** Once the Chainlist Dapp is open click on “Connect wallet” at right hand top corner and once the wallet is connected search of “SRI Blockchain” on the list of EVM networks. Click on “Add to imToken” next to SRI Blockchain Mainnet and “Approve” the details of SRI Blockchain RPC on the next step as shown below.
...
**Step 5:** Now you have successfuly added SRI Blockchain network RPC on imToken wallet. You can now send/receive SRI Blockchain network assets on imToken wallet.  
