...
We will learn how to connect Ledger to Metamask and use it on SRI Blockchain network after the latest Metamask and Ledger live update.
...
You will be logged in to the address you selected and now you can change to “SRI Blockchain network” and perform the transactions on SRI Blockchain network through your Ledger device.

Note: To learn how to add SRI Blockchain network RPC follow [this link.](https://doc.poolscan.io/the-SRI-studio/getting-started/how-to-add-SRI-to-your-metamask)
