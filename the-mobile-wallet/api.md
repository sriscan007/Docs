...
## SRI-studio-backend v0.1.0

The SRI Blockchain Studio REST API for accessing the data and the services of the SRI Blockchain network in a simple way. You can use this API to query and interact with the objects of the SRI Blockchain network such as: Communities, Tokens, Bridges and Entities.

## Bridge

### Fetch bridge

The token bridge connects the Ethereum and SRI Blockchain network
...
| :--- | :--- | :--- |
| homeTokenAddress | `String` | Home \(SRI Blockchain\) token address |

#### Success 200

| Name | Type | Description |
| :--- | :--- | :--- |
| homeTokenAddress | `String` | Token address on the SRI Blockchain network |
...
| homeBridgeAddress | `String` | Bridge address on the SRI Blockchain network |
| homeBridgeBlockNumber | `Number` | Bridge creation block number on the SRI Blockchain network |
...
Community is a set of contracts and services. Members of the community are users of the SRI Blockchain network. The community is configured via the plugins.
...
| Name | Type | Description |
| :--- | :--- | :--- |
| communityAddress | `String` | Address of the community on the SRI Blockchain network |
| homeTokenAddress | `String` | Address of the community token on the SRI Blockchain network |
| foreignTokenAddress | `String` | Address of the community token on the Ethereum network |
| homeBridgeAddress | `String` | Address of the community bridge on the SRI Blockchain network |
...
| Name | Type | Description |
| :--- | :--- | :--- |
| communityAddress | `String` | Community address of the SRI Blockchain network |
...
Entity is an account on the SRI Blockchain network. It can have variety of roles like user, admin, business, or custom defined role.
...
| Name | Type | Description |
| :--- | :--- | :--- |
| account | `String` | Entity's account on SRI Blockchain network |
...
Tokens are compatible with the SRI20 standard, and they also can be burnable/mintable. Tokens are an important part of the community economy.
...
| networkType | `String` | Network type where the token is issued: mainnet/ropsten/SRI |
...
| Name | Type | Description |
| :--- | :--- | :--- |
| networkType | `String` | mainnet/ropsten/SRI |
| page | `Number` | Page number for pagination |
