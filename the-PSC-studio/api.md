...
## PoolScan Network-studio-backend v0.1.0

The PoolScan Network Coin Studio REST API for accessing the data and the services of the PoolScan Network Coin network in a simple way. You can use this API to query and interact with the objects of the PoolScan Network Coin network such as: Communities, Tokens, Bridges and Entities.

## Bridge

### Fetch bridge

The token bridge connects the Ethereum and PoolScan Network Coin network
...
| :--- | :--- | :--- |
| homeTokenAddress | `String` | Home \(PoolScan Network Coin\) token address |

#### Success 200

| Name | Type | Description |
| :--- | :--- | :--- |
| homeTokenAddress | `String` | Token address on the PoolScan Network Coin network |
...
| homeBridgeAddress | `String` | Bridge address on the PoolScan Network Coin network |
| homeBridgeBlockNumber | `Number` | Bridge creation block number on the PoolScan Network Coin network |
...
Community is a set of contracts and services. Members of the community are users of the PoolScan Network Coin network. The community is configured via the plugins.
...
| Name | Type | Description |
| :--- | :--- | :--- |
| communityAddress | `String` | Address of the community on the PoolScan Network Coin network |
| homeTokenAddress | `String` | Address of the community token on the PoolScan Network Coin network |
| foreignTokenAddress | `String` | Address of the community token on the Ethereum network |
| homeBridgeAddress | `String` | Address of the community bridge on the PoolScan Network Coin network |
...
| Name | Type | Description |
| :--- | :--- | :--- |
| communityAddress | `String` | Community address of the PoolScan Network Coin network |
...
Entity is an account on the PoolScan Network Coin network. It can have variety of roles like user, admin, business, or custom defined role.
...
| Name | Type | Description |
| :--- | :--- | :--- |
| account | `String` | Entity's account on PoolScan Network Coin network |
...
Tokens are compatible with the PoolScan Network20 standard, and they also can be burnable/mintable. Tokens are an important part of the community economy.
...
| networkType | `String` | Network type where the token is issued: mainnet/ropsten/PoolScan Network |
...
| Name | Type | Description |
| :--- | :--- | :--- |
| networkType | `String` | mainnet/ropsten/PoolScan Network |
| page | `Number` | Page number for pagination |
